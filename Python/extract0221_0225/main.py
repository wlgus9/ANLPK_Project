import pandas as pd
import Python.extract0221_0225.word_extract as word_extract
...
### 우리 수집 데이터
# 데이터 로드
news_data = pd.read_csv("Python/extract0221_0225/news_0118~0218.csv", encoding='utf-8')
train_data = news_data.copy()
print(train_data.isnull().sum())

# 2002-2019 신조어 목록 불러오기
mecab_new_corpus = pd.read_csv("Python/extract0221_0225/mecab_new_corpus.csv",encoding="cp949")
...
df_new_words.to_csv('new_words_temp_0225_society.csv', index=False, encoding='utf-8-sig')
